...
//       : ConversionPattern(ada::PrintOp::getOperationName(), 1, context) {}
...
//     auto printOp = cast<ada::PrintOp>(op);
//     auto elementLoad =
...
struct AdaToLLVMLoweringPass
  ...
  void getDependentDialects(DialectRegistry &registry) const override {
      // TODO: SCFDialet not used, clean: remove it
    registry.insert<LLVM::LLVMDialect, scf::SCFDialect, func::FuncDialect, arith::ArithDialect>();
  }
...
struct BinaryOpLowering : public ConversionPattern {
  ...
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    //                                                         loadedRhs);
    //                });
    rewriter.replaceOpWithNewOp<LoweredBinaryOp>(op, op->getOperands());
    return success();
  }
};
