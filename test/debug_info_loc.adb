...
-- CHECK:         %{{.*}} = ada.binop "+" %arg0, %arg1 checks<overflow> : !ada.qual<i32, @standard.integer> loc("{{.*}}debug_info_loc.adb":15:13 to :14)
-- CHECK:         %{{.*}} = ada.binop "+" %{{.*}}, %arg2 checks<overflow> : !ada.qual<i32, @standard.integer> loc("{{.*}}debug_info_loc.adb":15:17 to :18)
