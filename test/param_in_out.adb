...
-- MLIR:         ada.subp @increment(%arg0: memref<!ada.qual<i32, @standard.integer>>)
...
-- MLIR:         ada.call @increment(%[[N_PTR]]) : (memref<!ada.qual<i32, @standard.integer>>) -> ()
...
-- LLVM-LABEL: define void @param_in_out__increment(ptr
